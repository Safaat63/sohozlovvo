      ...
      <div className="p-4 space-y-5 overflow-y-auto flex-1">
        {session?.user ? (
          <Link
            href="/account"
            onClick={closeMenu}
            className="flex items-center gap-3 rounded-2xl bg-primary text-primary-foreground p-4"
          >
  ...
  return (
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger className={triggerClassName || "text-foreground"}>
          <svg
        ...
        <SheetContent
          side="left"
          className="w-[320px] max-w-[90vw] p-0 pt-5 bg-background text-foreground border-border"
        >
          {menuContent}
        </SheetContent>
      </Sheet>
