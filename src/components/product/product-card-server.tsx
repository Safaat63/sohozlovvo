...
export async function ProductCardServer({ product, whatsappNumber, priority = false }: ProductCardServerProps) {
        ...
        ? product.variations.map((variation: any) => ({
            ...
            options: Array.isArray(variation.options)
                ? variation.options.map((option: any) => ({
                    ...
                    price: typeof option.price === "object" && option.price !== null && "toNumber" in option.price
    ...
    const flashSales = Array.isArray(product.flashSales)
        ? product.flashSales.map((fs: any) => ({
            id: fs.id,
            salePrice: typeof fs.salePrice === "object" && fs.salePrice !== null && "toNumber" in fs.salePrice
