            ...
            <SheetContent className="flex flex-col border-l border-border px-4 sm:px-6 bg-background text-foreground h-full inset-y-0 top-0 bottom-0 rounded-none w-full max-w-none sm:max-w-sm sm:inset-y-0">
                ...
                {items.length === 0 ? (
                    <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                        ...
                        <h3 className="font-semibold mb-2 text-foreground">Your bag is empty</h3>
                    ...
                    <>
                        ...
                        {relatedProducts.length > 0 ? (
                            <div className="border-t border-border pt-3">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-base font-semibold text-foreground">You May Also Like</h3>
                                ...
                                >
                                    {relatedProducts.map((product) => (
                                        <div
                                            key={product.id}
                                            className="min-w-[210px] max-w-[220px] border border-border rounded-xl p-2 bg-card flex items-center gap-3"
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="mt-1 flex items-center justify-between gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isPending || addingRelatedId === product.id}
                                                    >
                                                        + Add
                                                    </button>
                                                </div>
