...
export function SortSelect({ defaultValue = "newest" }: SortSelectProps) {
    ...
    return (
        <div className="relative">
            <select
                id="sort"
                className="appearance-none bg-muted border-none rounded-lg py-2 pl-3 pr-8 text-sm font-semibold text-foreground focus:ring-1 focus:ring-primary cursor-pointer"
