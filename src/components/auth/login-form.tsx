    ...
    return (
        <div className="w-full max-w-md rounded-[28px] bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] dark:bg-zinc-900 dark:shadow-[0_20px_60px_rgba(0,0,0,0.3)] md:p-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Signin</h1>
                    <p className="text-sm text-slate-500 dark:text-zinc-400">Access your account securely</p>
                </div>
            </div>

            <div className="mt-6 rounded-2xl bg-slate-50/80 p-4 dark:bg-zinc-800/80 md:p-6">
                <h2 className="text-base font-semibold text-slate-800 dark:text-zinc-200">Login With Credentials</h2>
                ...
                <form onSubmit={handleSubmit} className="mt-4 space-y-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center gap-2 text-slate-600 dark:text-zinc-400">
                            <input
                                type="checkbox"
                                className="size-4 rounded border-slate-300 text-orange-500 focus:ring-orange-200 dark:border-zinc-600 dark:bg-zinc-800"
                                disabled={loading}
                            />
                            Remember me
                        </label>
                        <Link href="/auth/forgot-password" className="text-orange-500 hover:underline dark:text-orange-400">
                            Forgotten password?
                        </Link>
                    </div>
            ...
            <p className="mt-6 text-center text-sm text-slate-600 dark:text-zinc-400">
                ...
                <Link href="/auth/register" className="font-medium text-orange-500 hover:underline dark:text-orange-400">
                    Register account
                </Link>
            </p>
        </div>
